        ...
        <>
            ...
            <div className="  w-56 p-2 min-w-56 bg-[#FFF] h-80  z-50 ">
                <div className=' relative hover:cursor-pointer '>
                    ...
                    <img src={`${x.thumbnail}`} width={400} height={400} className='   z-50  w-full h-56 rounded-3xl' alt='some'></img>
                ...
                <div className=' '>
                    ...
                    <h5 className=' mt-2 text-end   font-bold text-[#333333]'>{x.name}</h5>
                    <div className=' flex   flex-row    '>
                        ...
                        <h5 className='  mb-auto -pt-4 text-end mx-2 pm-1 -mt-1 font-extralight text-[#333333] '> صادق </h5>
                    </div>
                </div>
