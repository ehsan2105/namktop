        ...
        <>
            ...
            <div className="  w-56 p-2 min-w-56 bg-[#FFF] h-80  z-50 ">
                <div className=' relative hover:cursor-pointer '>
                    ...
                    <Image src={test1} className='   z-50  w-full h-56 rounded-3xl' alt='some'></Image>
                    ...
                    <div className=' absolute  test  top-[25%] left-0  w-full   h-[75%]     bg-gradient-to-t from-[#2e2c2ca1] rounded-b-3xl'>
                        <div className='  -top-[33%] z-50  testi absolute  bg-[#00A693] justify-center items-cente mx-auto inline-flex   -p-2  rounded-tl-3xl rounded-br-3xl    w-[6.5rem] h-[3.5rem] '>
                            <div className='z-30 svg '>
                                ...
                                <p className=' flex  justify-center  text-white     '>me</p>
                            </div>
                        </div>
                        <div className=' flex       '>
                            <div className='     mt-20   flex   flex-col  justify-end items-end '>
                                ...
                                <p className=' text-[#CCC] font-normal text-xs ml-4'>tete</p>
                                <button className=' w-12 h-7 justify-center items-center  bg-[#00A693] rounded-full mb-2  text-[#FFFF] mr-2'> some</button>
                            </div>
                            <div className='flex flex-col mr-12 mt-auto'>
                                <div className=' flex '>
                                    <h1 className=' px-1 py-1 rounded-full font-normal text-[#FFFF] text-xs      mx-auto bg-[#C62020]'>20%</h1>
                                    <h1 className=' font-normal text-[#FFFF] text-base line-through'>24000</h1>
                                </div>
                                <div>
                                    <h1 className=' font-bold text-3xl text-[#FFFF]'>20000</h1>
                                </div>
                            </div>
                        </div>
                    </div>
